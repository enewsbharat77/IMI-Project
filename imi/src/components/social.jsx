    ...
    <>
      ...
      <div className="hidden md:fixed md:flex md:flex-col md:right-0 md:top-1/3 bg-white shadow-lg rounded-l-2xl z-50">
        <div className="flex flex-col text-3xl space-y-4 p-3">
          ...
          <a href="https://www.instagram.com/imibharat/" target="_blank" rel="noopener noreferrer" className="text-[#E4405F] hover:scale-110 transition-transform">
            <FaInstagram />
          </a>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white flex justify-around py-3 text-3xl shadow-inner z-50">
        <a href="https://www.facebook.com/imibharat/" className="text-[#1877F2]">
          <FaFacebook />
        </a>
        <a href="https://www.instagram.com/imibharat/" className="text-[#E4405F]">
          <FaInstagram />
        </a>
